                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" College Online Transport, College Online Transport, College Online Transport"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Management System, Management System, Management System"></span>
                            </h1>

                            <p class="main-heading-text">WELCOME TO,<br />COLLEGE ONLINE TRANSPORT MANAGEMENT SYSTEM</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">COTMS Contact List</h1>

                            <p class="main-heading-text">The college transport management system allows you to book bus ticket for your campus accurately. 
                                <br />Manage vehicle allocation during the academic year with proper allotment of vehicles to students including 
								the boarding points and destinations in particular routes..
                            </p>
